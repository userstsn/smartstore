...
for (data of api){
const cat_name = document.querySelectorAll(".cat_name_");


console.log(cat_name.length)


// condition set for not repeating same categorioes
if(cat_name.length !== 0){
let last = cat_name.length;
    if(cat_name[last - 1].innerHTML !== data.category){

        categories.innerHTML += `
        <a href="product.html?${data.category}">
    <div class="card">
            <div class="img-bg">
                <img src="./pic/img/${data.category}/${data.image}" alt="">
            </div>
            <div class="details">
                <p class="name cat_name_" style="text-transform:uppercase">${data.category}</p>
            </div>
        </div>
        </a>
`
